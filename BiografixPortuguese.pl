...
#Create new sentences out of parentehical structures with biographical information. Portuguese version.
...
#PRINT NEW SENTENCE
  ...
  print "a $date"; 
    ...
    print ".\n";
	 ...
	 print "$town é em $province.\n";
     }

    if(($state ne "") && ($province ne ""))  {
	
	print "$province é em $state.\n";
     }

     if(($state ne "") && ($place4 ne ""))  {
	 
	print "$state é em $place4.\n";
     }
