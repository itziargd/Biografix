...
#Create new sentences out of parentehical structures with biographical information. French version.
...
#PRINT NEW SENTENCE
  ...
  print "le $date";
    ...
    print ".\n";
	 ...
	 print "$town est en $province.\n";
     }

    if(($state ne "") && ($province ne ""))  {
	
	print "$province est en $state.\n";
     }

     if(($state ne "") && ($place4 ne ""))  {
	 
	print "$state est en $place4.\n";
     }
