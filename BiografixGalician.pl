...
#Create new sentences out of parentehical structures with biographical information. Galician version.
...
#PRINT NEW SENTENCE
  ...
  print "o $date";
    ...
    print ".\n";
	 ...
	 print "$town está en $province.\n";
     }

    if(($state ne "") && ($province ne ""))  {
	
	print "$province está en  $state.\n";
     }

     if(($state ne "") && ($place4 ne ""))  {
	 
	print "$state está en $place4.\n";
     }
